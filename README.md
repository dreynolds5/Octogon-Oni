...
[Application Repo Link](https://github.com/amehlhase316/SER316-S26C-Verschnaufpause)
...
If you are using IntelliJ it should pull all the dependencies right from the Gradle file and it should work right away.
